...
var displayProducts = function() {
  var query = 'SELECT * FRO M Produ cts'
     ...
     shoppingCart();
       ...
       validate: function(value) {
         ...
         // * -- Once the customer has placed the order: Your application should...
                // * Check if your store has en ou gh  quantity of the product to meet the customer's request.
        ...
        var query = 'SELECT * FROM Products WHERE itemID=' + answer.Quantity;
                 connection.query(quer y, function(err, res) {
